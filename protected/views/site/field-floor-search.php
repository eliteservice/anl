			...
			if (issetModule('selecttoslider') && param('useFloorSlider') == 1) {
				...
				<span class="search">
					...
					echo '<div class="index-search-form floor-search-select">';
						echo CHtml::dropDownList('floorMin', $floorMin, $floorItems, array('style' => 'display: none;', 'class' => 'searchField'));
						echo CHtml::dropDownList('floorMax', $floorMax, $floorItems, array('style' => 'display: none;', 'class' => 'searchField'));
						echo '<div class="vals">';
				...
				Yii::app()->clientScript->registerScript('floor', '
					$("select#floorMin, select#floorMax").selectToUISlider({labels: 2, tooltip: false, tooltipSrc : "text",	labelSrc: "text",  sliderOptions: { stop: function(e,ui) {  changeSearch(); } }});
