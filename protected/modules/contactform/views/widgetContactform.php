<h2><?php echo tt('we are', 'contactform'); ?></h2>
<style>
    #map-canvas {
        height: 300px;
        width: 100%;
...
<script>
    ...
    function initialize() {
        var mapOptions = {
            zoom: 14,
            center: new google.maps.LatLng(54.89982173919454, 69.14670467376709),
        ...
        marker = new google.maps.Marker({
            ...
            position: new google.maps.LatLng(54.900203, 69.146538)
        });
    }
